        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoColor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoPedidoModelId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pedido_Cliente_ClienteModelID",
                        column: x => x.ClienteModelID,
                        principalTable: "Cliente",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pedido_EstadoPedido_EstadoPedidoModelId",
                        column: x => x.EstadoPedidoModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Precio = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PedidoModelId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallePedido_Pedido_PedidoModelId",
                        column: x => x.PedidoModelId,
                        principalTable: "Pedido",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallePedido_ProductoModel_ProductoModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallePedido_PedidoModelId",
                table: "DetallePedido",
                column: "PedidoModelId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallePedido_ProductoModelId",
                table: "DetallePedido",
                column: "ProductoModelId");

            migrationBuilder.CreateIndex(
                name: "IX_Pedido_ClienteModelID",
                table: "Pedido",
                column: "ClienteModelID");

            migrationBuilder.CreateIndex(
                name: "IX_Pedido_EstadoPedidoModelId",
                table: "Pedido",
                column: "EstadoPedidoModelId");
        }
